...
_C.MODEL.arch_decoder = "ppm"
# weights to finetune net_encoder
_C.MODEL.weights_encoder = "./ade20k-resnet50/encoder_epoch_20.pth"
# weights to finetune net_decoder
_C.MODEL.weights_decoder = "./ade20k-resnet50/decoder_epoch_20.pth"
